...
the expiration settings accordingly. By default, entries expire after 10 minutes.

|`initializr.dependency-metadata`
|Cache dependency-specific metadata. By default, entries expire after 10 minutes.
